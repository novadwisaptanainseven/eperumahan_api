...
class BrosurController extends Controller
{
    ...
    public function addBrosur(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'brosur_pengembang' => "required|mimes:jpg,jpeg,png|max:5048"
        ], $message);
        ...
        if ($tambah === 'WRONG_EXTENSION') {
            ...
            return response()->json([
                "message" => "Tambah brosur pengembang gagal, Gagal",
                "data"    => $tambah
            ], 500);
        }
    }
    ...
    {
        return response()->json([
            "message" => "Delete brosur pengembang dengan id brosur: $id_brosur"
        ], 201);
    }
}
